...
class AffectPredictor(object):
    ...
    CLASS_DIC = {0: "0: no __ can be inferred", 1: "1: low amount of __ can be inferred",
                 2: "2: moderate amount of __ can be inferred", 3: "3: high amount of __ can be inferred"}
