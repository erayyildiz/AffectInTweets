...
if __name__ == "__main__":
    ...
    # word_index = None
    train_model("joy_en", "data/semeval2018 task 1/EI-reg-En-joy-train.txt",
                "data/semeval2018 task 1/EI-oc-En-joy-train.txt",
                "data/semeval2018 task 1/2018-EI-reg-En-joy-dev.txt",
                "data/semeval2018 task 1/2018-EI-oc-En-joy-dev.txt",
